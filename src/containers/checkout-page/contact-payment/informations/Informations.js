...
class Informations extends Component {
    ...
    render(){
       ...
       let cityPostalCode;
        ...
        firstLastName = (
            formArray.map(elem =>{
                console.log(elem.id)
                if(elem.id == 'firstName' || elem.id == 'lastName'){
                    return(
       ...
       cityPostalCode = (
        formArray.map(elem =>{
            console.log(elem.id)
            if(elem.id === 'city' || elem.id == 'postalCode'){
                return(
    ...
    other = (
        formArray.map(elem =>{
            console.log(elem.id)
            if(elem.id !== 'firstName' && elem.id !== 'lastName' && elem.id !== 'city' && elem.id !== 'postalCode'){
                return(
                    <div>
                        <Input 
                        key={elem.id}
            ...
            <div className='informations-container'>
                ...
                <form onSubmit={this.submitForm} className={this.state.showPayment ? 'hide' : null}>
                    ...
                    <div className='info-text-container'>
                        ...
                        <div className='first-last-name'>{firstLastName}</div>
                        {other}
                        <div className='first-last-name'>{cityPostalCode}</div>
